...
start "RMQC2"    java -jar replicamanager/target/replicamanager-1.0.jar RA QC 2
start "RMQC3"    java -jar replicamanager/target/replicamanager-1.0.jar MA QC 3
start "RMBC1"    java -jar replicamanager/target/replicamanager-1.0.jar SY BC 1
start "RMBC2"    java -jar replicamanager/target/replicamanager-1.0.jar RA BC 2
start "RMBC3"    java -jar replicamanager/target/replicamanager-1.0.jar MA BC 3
start "RMNB1"    java -jar replicamanager/target/replicamanager-1.0.jar SY NB 1
start "RMNB2"    java -jar replicamanager/target/replicamanager-1.0.jar RA NB 2
start "RMNB3"    java -jar replicamanager/target/replicamanager-1.0.jar MA NB 3
start "RMMB1"    java -jar replicamanager/target/replicamanager-1.0.jar SY MB 1
start "RMMB2"    java -jar replicamanager/target/replicamanager-1.0.jar RA MB 2
start "RMMB3"    java -jar replicamanager/target/replicamanager-1.0.jar MA MB 3
pause